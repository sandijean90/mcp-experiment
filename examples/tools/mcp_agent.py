...
current_dir = os.getcwd()  # /Users/sandi/beeai-framework/

# Move into 'python/examples' from the current directory
examples_dir = os.path.join(current_dir, 'python')  # /Users/sandi/beeai-framework/python/examples
